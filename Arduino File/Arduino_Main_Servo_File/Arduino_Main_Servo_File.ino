...
int HeadFunction(){  // HeadFunction Start
...
int RightHandFunction(){// RightHandFunction Start
...
int LeftHandFunction(){ // LeftHandFunction Start
...
int WristFunction(){ // WristFunction Start
